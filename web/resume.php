  ...
  <body>
    ...
    <div class="site-wrap">
      ...
      <div class="offcanvas_menu" id="offcanvas_menu">
        ...
        <ul class="social">
          <li><a href="https://github.com/C616624830" class="fa fa-github-square" style="font-size:20px"></a></li>
        </ul>
      ...
      <main>
        ...
        <div class="mb-5">
          <ul class="resume-list">
            <li>
              <h3>Rutgers University, RA</h3>
              <p class="date">Jan 2019 - May 2019</p>
              <p>Lab Assistant/Software developer</p>
              <p>Used standard Android Open Source Project(AOSP) keyboard as a base to design an optimized keyboard layout.</p>
              <p>Developped an algorithm to compute the minimum number of transitions from one keyboard layout to another keyboard layout.</p>
              <p>Developped a C++ program to produce the all xml files needed to perform the transition.</p>
              <p>Modified the original project to make the keyboard layout set on android devices periodically change by a certain amount of time.</p>
            </li>
        </div>
          ...
          <div class="row">
            <div class="col-md-10">
                            <div class="skills portfolio-info-card">
                                ...
                                <h3>Python</h3>
                                <div class="progress">
                                    <div class="progress-bar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100" style="width: 100%;"><span class="sr-only">90%</span></div>
                                </div>
                                <h3>MySQL</h3>
                                <div class="progress">
                                    <div class="progress-bar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style="width: 100%;"><span class="sr-only">80%</span></div>
                                </div>
                                <h3>Android</h3>
                                <div class="progress">
                                    <div class="progress-bar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style="width: 100%;"><span class="sr-only">80%</span></div>
